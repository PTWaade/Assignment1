...
There is a positive relation of 0.1 per visit between time and the child's MLU, statistically significant to p<0.05 (t(59.4) = 3.69).
There is no significant relation between autism diagnosis and MLU, p>0.05 (t(57.4) = -1.26).
There is a positive interaction effect between time and diagnosis, typically developing children increasing their MLU per visit by 0.25 more than autistically diagnosed kid, statistically significant to p<0.05 (t(59.9) = 6.72)
...
There is a smaller but not irrelevant positive relation of 0.13 per visit between time and mother's MLU, statistically significant to p<0.05 (t(57.2) = 3.74).
Typically developing children on average have a MLU larger by 0.36 than autistically diagnosed kids significant to p<0.05 (t(57.9) = 2.02).
There is no singificant interaction effect between growth over time and diagnosis, p>0.05 (t(57.7) = 1.1)
...
Model_0 = lmer(CHI_MLU ~ VISIT + types_CHI + (1+VISIT|SUBJ), d)
