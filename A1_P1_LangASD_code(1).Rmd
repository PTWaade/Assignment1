...
```{r}
#Make ID into numbers    #######Problem########
as.numeric(as.factor(d$SUBJ))

#Make visit numeric
d$VISIT=as.numeric(d$VISIT)

#Change names of genders and Diagnosis
d$Gender = as.factor(d$Gender)
d$Gender = revalue(d$Gender, c("1" = "F", "2" = "M"))
...
#Also an option... not split ub by kids..
d_temp = mutate(d, avgWords_CHI = mean(tokens_CHI))
