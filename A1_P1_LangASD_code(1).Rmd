...
### 3 #######PROBLEM#######
#Create groups by how many visits made, then filter for the ones with less than 6 visits
chi_3 = d %>%
  group_by(VISIT) %>%
  filter(VISIT < 6)
#List all the kids - all the different values in the SUBJ column
levels(as.factor(chi_3$SUBJ))
levels(as.factor(d$SUBJ))
----------
```
