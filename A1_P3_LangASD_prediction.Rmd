...
#Preperations for loop - result lists and n
rmse_train = NULL
rmse_test = NULL
n = 1
...
for (i in Folds) {
  ...
  Model_temp = lmer(CHI_MLU ~ VISIT*Diagnosis + (1+VISIT|SUBJ), dtrain_temp)
  ...
  #Next loop new placement in result lists. Loop end
  n=n+1  }
...
Joe_scores = predict(Model_0, AvgJoe, allow.new.levels=T)
